...
public  class LeeLunar {
 ...
 /*   private static String[] yearName = {"零", "壹", "贰", "叁", "肆", "伍", "陆",
            "柒", "捌", "玖"};*/
 private static String[] yearName = {"零","一", "二", "三", "四", "五", "六", "七",
         "八", "九"};
...
private static void Lunar1(Date objDate) {
   ...
   public  String getLunar(String year, String month, String day) {
    ...
    public  String getLunar1(String year, String month, String day) {
        Date sDObj;
        String s;
        int SY, SM, SD;
        int sy;
        ...
        //日期
        Lunar1(sDObj); //农历
        s = "" +  monthNong[getMonth()] + "月 "+cDay(getDay()) ;
        return s;
    }
}